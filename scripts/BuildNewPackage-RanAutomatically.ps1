...
#==========================================================
param ([string]$ProjectFilePath, [string]$OutputDirectory, [string]$Configuration, [string]$Platform, [string] $NupkgOutputPath)
...
& "$THIS_SCRIPTS_DIRECTORY\New-NuGetPackage.ps1" -ProjectFilePath "$ProjectFilePath" -VersionNumber $versionNumber -ReleaseNotes $releaseNotes -PackOptions "-OutputDirectory ""$NupkgOutputPath"" -Properties $packProperties -NonInteractive $additionalPackOptions" -DoNotUpdateNuSpecFile -NoPrompt -Verbose